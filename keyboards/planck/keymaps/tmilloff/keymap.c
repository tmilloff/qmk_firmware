...
[_GUI] = LAYOUT_planck_grid(
    ...
    DYN_MACRO_PLAY1, _______, _______, _______, _______, _______, KC_HOME, KC_PGDN, KC_PGUP, KC_END, _______, DYN_MACRO_PLAY2,
    DYN_REC_START1, _______, _______, _______, _______, DYN_REC_STOP, DYN_REC_STOP, _______, _______, _______, _______, DYN_REC_START2
),
