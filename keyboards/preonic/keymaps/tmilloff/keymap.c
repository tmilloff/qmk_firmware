...
[_GUI] = LAYOUT_preonic_grid(
  ...
  MO(_MACRO), _______, _______, _______, _______, TG(_ONEHANDBASE), TG(_ONEHANDBASE), _______, _______, _______, _______, MO(_MACRO)
),
 ...
 * `-----------------------------------------------------------------------------------'
 */
[_ONEHANDBASE] = LAYOUT_preonic_grid( \
  KC_GRV,  KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_DEL,
  KC_TAB,  KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,    KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,    KC_BSPC,
  LCTL_T(KC_ESC),  KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, RCTL_T(KC_QUOT),
  KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, RSFT_T(KC_ENT),
  TG(_ONEHANDBASE), KC_LCTL, KC_LALT, KC_LGUI, KC_SPACE,   LT(_ONEHANDFLIP, KC_SPACE), LT(_ONEHANDFLIP, KC_SPACE),  KC_SPACE,   KC_RGUI, KC_RALT, KC_RCTL, TG(_ONEHANDBASE)
),

/* One hand (Based on qwerty)
 * ,-----------------------------------------------------------------------------------.
 * |  Del |  0   |  9   |  8   |  7   |  6   |  5   |  4   |  3   |  2   |  1   |  `   |
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * | Bksp |  P   |  O   |  I   |  U   |  Y   |  T   |  R   |  E   |  W   |  Q   |  Tab |
 * |------+------+------+------+------+-------------+------+------+------+------+------|
 ...
 * `-----------------------------------------------------------------------------------'
 */
[_ONEHANDFLIP] = LAYOUT_preonic_grid( \
  ...
  RCTL_T(KC_QUOT), KC_SCLN, KC_L, KC_K, KC_J, KC_H, KC_G, KC_F, KC_D, KC_S, KC_A, LCTL_T(KC_ESC),
  RSFT_T(KC_ENT), KC_SLSH, KC_DOT, KC_COMM, KC_M, KC_N, KC_B, KC_V, KC_C, KC_X, KC_Z, KC_LSFT,
  _______, _______, _______, _______, _______,   _______,  _______,  _______,   _______, _______, _______, _______
),
};
